...
// CMT2 CMI2
#pragma interrupt (Excep_CMT2_CMI2(vect=30, enable))	// 200us for USB routine, Sean, 2014/09/16
...
// USB0 D0FIFO0
//#pragma interrupt (Excep_USB0_D0FIFO0(vect=33))	// combine ED&USB, Sean, 20140812
...
// USB0 USBI0	
//#pragma interrupt (Excep_USB0_USBI0(vect=35))	// combine ED&USB, Sean, 20140812
...
// CAN1 RXM1
#pragma interrupt (Excep_CAN1_RXM1(vect=47, enable))
void Excep_CAN1_RXM1(void);

// CAN1 TXM1
#pragma interrupt (Excep_CAN1_TXM1(vect=48, enable))
...
// DPC RBI0
#pragma interrupt (Excep_DPC_RBI0(vect=58))
void Excep_DPC_RBI0(void);

// DPC RBI1
#pragma interrupt (Excep_DPC_RBI1(vect=59))
void Excep_DPC_RBI1(void);

// DPC RBI2
#pragma interrupt (Excep_DPC_RBI2(vect=60))
void Excep_DPC_RBI2(void);

// DPC RBI3
#pragma interrupt (Excep_DPC_RBI3(vect=61))
void Excep_DPC_RBI3(void);

// DPC RBI4
#pragma interrupt (Excep_DPC_RBI4(vect=62))
void Excep_DPC_RBI4(void);

// ICU IRQ0
//#pragma interrupt (Excep_ICU_IRQ0(vect=64))	// combine ED&USB, Sean, 20140812
//void Excep_ICU_IRQ0(void);

// ICU IRQ1
//#pragma interrupt (Excep_ICU_IRQ1(vect=65))	// combine ED&USB, Sean, 20140812
//void Excep_ICU_IRQ1(void);

// ICU IRQ2
//#pragma interrupt (Excep_ICU_IRQ2(vect=66))	// combine ED&USB, Sean, 20140812
...
// USB USBR0
//#pragma interrupt (Excep_USB_USBR0(vect=90))	// combine ED&USB, Sean, 20140812
...
// S12AD S12GBADI0
#pragma interrupt (Excep_S12AD_S12GBADI0(vect=103))
...
// ICU GROUP0
#pragma interrupt (Excep_ICU_GROUP0(vect=106, enable))
void Excep_ICU_GROUP0(void);

// ICU GROUP12
#pragma interrupt (Excep_ICU_GROUP12(vect=114, enable))
...
// MTU0 TGIA0
#pragma interrupt (Excep_MTU0_TGIA0(vect=126, enable))
...
// MTU0 TCIV0
#pragma interrupt (Excep_MTU0_TCIV0(vect=130, enable))
...
// MTU1 TCIV1
#pragma interrupt (Excep_MTU1_TCIV1(vect=135, enable))
void Excep_MTU1_TCIV1(void);

// MTU1 TCIU1
#pragma interrupt (Excep_MTU1_TCIU1(vect=136, enable))
...
// MTU3 TGIA3
#pragma interrupt (Excep_MTU3_TGIA3(vect=141, enable))
...
// MTU6 TGID6
#pragma interrupt (Excep_MTU6_TGID6(vect=157, enable))
...
// POE OEI1
#pragma interrupt (Excep_POE_OEI1(vect=166, enable))
void Excep_POE_OEI1(void);

// POE OEI2
#pragma interrupt (Excep_POE_OEI2(vect=167, enable))
void Excep_POE_OEI2(void);

// POE OEI3
#pragma interrupt (Excep_POE_OEI3(vect=168, enable))
void Excep_POE_OEI3(void);

// POE OEI4
#pragma interrupt (Excep_POE_OEI4(vect=169, enable))
...
// SCI0 RXI0
#pragma interrupt (Excep_SCI0_RXI0(vect=214, enable))
...
// SCI0 TEI0
#pragma interrupt (Excep_SCI0_TEI0(vect=216, enable))
...
// SCI2 RXI2
#pragma interrupt (Excep_SCI2_RXI2(vect=220, enable))
...
// SCI2 TEI2
#pragma interrupt (Excep_SCI2_TEI2(vect=222, enable))
void Excep_SCI2_TEI2(void);

// SCI3 RXI3
#pragma interrupt (Excep_SCI3_RXI3(vect=223, enable))
...
// SCI3 TEI3
#pragma interrupt (Excep_SCI3_TEI3(vect=225, enable))
