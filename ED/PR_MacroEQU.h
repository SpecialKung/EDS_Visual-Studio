...
//#define SRY_A           PC.DR.BIT.B4	// Point A input  功能移除
//#define SRY_B           PC.DR.BIT.B5	// Point B input  功能移除
//#define SRY_C           PC.DR.BIT.B6	// Point C input  功能移除
//#define SRY_D           PC.DR.BIT.B7	// Point D input  功能移除
//#define SRY_T           PC.DR.BIT.B8	// Function test output  功能移除
...
//------ USB Enable --------------------------------------------------------//
//#define USBEN			PB.DR.BIT.B10	// USB Enable Pin  功能移除
...
#define C20MAX          (0x16+1)                	// MAX ITEM C20XX//2000H~2006H /未處理??
