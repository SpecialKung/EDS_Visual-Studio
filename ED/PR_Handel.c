...
void P04_50(UWORD prx, UWORD prvalue){
    ...
    if((pr[FLOOR_PAGE]==4)||(pr[FLOOR_PAGE]==5)||(pr[FLOOR_PAGE]==6)){ //[adjust floor position,Henry,2019/01/07]
        // �o�Ӽg�k �Ψӭ���L�դj�p----7/6/2018
        if(DLC_ulPgBrd !=0){
            //mod pulse to mm [
            //get brd's length mm
    	    //ulBrdLen = U32xU32divU32((DLC_ulPgBrd>>2), COF_ulPls2MMgain, 65536);	// Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 source
	        //ulBrdLen = ulBrdLen/10;//get borad's length								// Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 source
	        ulBrdLen = (ULONG)(((UDOUBLE)DLC_ulPgBrd * (UDOUBLE)COF_ulPls2MMgain + 1310720) / 2621440); // Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 new
	        if(DLC_ulPgSen && (DLC_ulPgSen<DLC_ulPgBrd)){
                //ulSenLen = U32xU32divU32((DLC_ulPgSen>>2), COF_ulPls2MMgain, 65536);	// Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 source
	            //ulSenLen = ulBrdLen/10;//get sensors distance							// Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 source
	            ulSenLen = (ULONG)(((UDOUBLE)DLC_ulPgSen * (UDOUBLE)COF_ulPls2MMgain + 1310720) / 2621440); // Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 new
            }
            else
                ulSenLen = 0;            
            swval = (SWORD)prvalue;
