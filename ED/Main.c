...
//    APR_status1.ub = 0;
  ...
  /*=========== PG Card type detact  ===========   //[Modify PG Type Define, Bernie, 12/05/2011]
	...
	//if((Driver_ID == IEDS_DRIVER) && ((pr[DLC_MODE3] & 0x01) != 0))	//Task 361568 撏????PU586皜祈岫APS?????? 鈭????摮貊????????敺???⊥??甇?撣賊??頧? //mitong 20230824 source
	//if(DLC_btAPS_Mode) //Task 361568 撏????PU586皜祈岫APS?????? 鈭????摮貊????????敺???⊥??甇?撣賊??頧? //mitong 20230824 new
    //{
