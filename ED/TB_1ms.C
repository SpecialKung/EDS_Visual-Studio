...
// -FAN CONTROL ----- added by scotty 10/15/20007
 ...
 // - END FAN CONTROL -----
	...
	if(TB_500us == 1){
		...
		//ulTmp = (SpDt_ulPG1Npulse>>2) * pr[FMAX];	// Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 source
		//COF_ulPls2MMgain = U32xU32divU32((pr[Lift_SPD]*COF_ubMPolePair), 655360000, ulTmp);	// Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 source
		udTmp = (UDOUBLE)SpDt_ulPG1Npulse * (UDOUBLE)pr[FMAX];	// Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 new
		COF_ulPls2MMgain = (ULONG)(((UDOUBLE)pr[Lift_SPD] * (UDOUBLE)COF_ubMPolePair * 2621440000 + (udTmp>>1)) / udTmp);	// Issue 277400 ���t�観����t�Υ��h���Ǫ����D // Mitong 20220902 new
