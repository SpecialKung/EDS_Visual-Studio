...
//	Row,	AddrHi,	AddrLo,	AddrPage,	"0123456789012345678901234",	Type,	
	...
	4U,		0xa1,	0x08,	0x00,		"DC-Bus(dcbusDC)          ",	3U,
	5U,		0xa1,	0x0c,	0x00,		"Out Volt(VcmdLLPF)       ",	4U,
	6U,		0xa1,	0x0e,	0x00,		"Out Cur(IrmsRe)          ",	3U,
	7U,		0xa1, 	0x10,	0x00,		"Torgue Cmd(swTqRefPu)    ",	4U,
	8U,	    0xa1, 	0x12,	0x00,		"AUI1(swAVICalib)         ",	4U,
	9U,		0xa1, 	0x14,	0x00,		"AUI2(swAUICalib)         ",	4U,
	10U,	0xa1,	0x16,	0x00,	    "mfi_status               ",	3U,

	11U,	0xa1,	0x18,	0x00,		"mfo_status               ",	3U,
	12U,	0xa1,	0x7A,	0x00,		"TB3_swAccOpt(Delta)      ",	4U,
	13U,	0xa1,	0x7E,	0x00,		"TB3_swAccOpt(GFC)        ",	4U,
	14U,	0xa1,	0x1c,	0x00,		"TB1_slSpdCmdPu           ",	4U,
	15U,	0xa1,	0x20,	0x00,		"SpDt_slSpdFdbPu          ",	4U,
	16U,	0xa1,	0x22,	0x00,		"CUR_swIqseRefPu          ",	4U,
	17U,	0xa1, 	0x24,	0x00,		"CUR_swIqseFdbPu          ",	4U,
	18U,	0xa1, 	0x26,	0x00,		"CUR_swIdseRefPu          ",	4U,
	19U,	0xa1, 	0x28,	0x00,		"CUR_swIdseFdbPu          ",	4U,
	20U,	0xa1, 	0x2a,	0x00,		"TB1_uwBrkRunCnt          ",	3U,

	21U,	0xa1,	0x2c,	0x00,		"TB1_uwBrkStopCnt		  ",	3U,
	22U,	0xa1,	0x2e,	0x00,		"TB1_uwMCRunCnt           ",	3U,
	23U,	0xa1,	0x30,	0x00,		"TB1_uwMCStopCnt          ",	3U,
	24U,	0xa1,	0x32,	0x00,		"TB1_uwStarConRunCnt      ",	3U,
	25U,	0xa1,	0x34,	0x00,		"TB1_uwStarConStopCnt     ",	3U,
	26U,	0xa1,	0x36,	0x00,		"TB1_uwDCICnt             ",	3U,
	27U,	0xa1, 	0x38,	0x00,		"uw_SCTEST8               ",	3U,
	28U,	0xa1, 	0x72,	0x00,		"zcal_uwMTU1cnt           ",	3U,//new add--aevin 7/24/2017
	29U,	0xa1, 	0x74,	0x00,		"hsd_uwAbsAngle           ",	3U,//new add--aevin 7/24/2017
	30U,	0xa1, 	0x40,	0x00,		"uwtest1                  ",	4U,

	31U,	0xa1, 	0x42,	0x00,		"uwtest2                  ",	4U,
	32U,	0xa1, 	0x44,	0x00,		"uwtest3                  ",	4U,
	33U,	0xa1,	0x46,	0x00,		"uwtest4   		          ",	4U,
	34U,	0xa1,	0x48,	0x00,		"uwtest5                  ",	4U,
	35U,	0xa1,	0x4a,	0x00,		"uwtest6				  ",	4U,
	36U,	0xa1,	0x4c,	0x00,		"uwtest7				  ",	4U,
	37U,	0xa1,	0x4e,	0x00,		"uwtest8				  ",	4U,
	38U,	0xa1,	0x50,	0x00,		"uwtest9				  ",	4U,
	39U,	0xa1,	0x52,	0x00,		"uwtest10				  ",	4U,
	40U,	0xa1,	0x54,	0x00,		"uwtest11				  ",	4U,

	41U,	0xa1,	0x56,	0x00,		"uwtest12				  ",	4U,
	42U,	0xa1,	0x58,	0x00,		"uwtest13				  ",	4U,
	43U,	0xa1, 	0x5a,	0x00,		"uwtest14                 ",	4U,
	44U,	0xa1, 	0x5c,	0x00,		"uwtest15                 ",	4U,
	45U,	0xa1,	0x5e,	0x00,		"uwtest16  		          ",	4U,
	46U,	0xa1,	0x60,	0x00,		"uwtest17                 ",	4U,
	47U,	0xa1,	0x62,	0x00,		"uwtest18				  ",	4U,
	48U,	0xa1,	0x64,	0x00,		"uwtest19				  ",	4U,
	49U,	0xa1,	0x66,	0x00,		"uwtest20				  ",	4U,
	50U,	0xa1,	0x68,	0x00,		"uwtest21				  ",	4U,

	51U,	0xa1,	0x6a,	0x00,		"uwtest22				  ",	4U,
	52U,	0xa1,	0x6c,	0x00,		"uwtest23				  ",	4U,
	53U,	0xa1,	0x6e,	0x00,		"uwtest24				  ",	4U,
	54U,	0xa1,	0x70,	0x00,		"uwtest25				  ",	4U,
